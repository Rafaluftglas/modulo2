...
function calcular() {
    ...
    `
     console.log(mediaIndividual/numero);
     console.log(mediaAritmetica/numero);
     console.log(mediaAritmeticaTrabalho/numero);
     console.log(Math.max(... notasProvas));
     console.log(Math.min(... notasProvas));
     console.log(Math.max(... notasTrabalho));
     console.log(Math.min(... notasTrabalho));
}